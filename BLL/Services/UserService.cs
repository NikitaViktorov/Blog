...
namespace BLL.Sevices
{
    public class UserService : IUserService
    {
        ...
        public async Task Create(UserDTO userDTO)
        {
            ...
            await _unitOfWork.Users.Create(mapper.Map<UserDTO, User>(userDTO));
        }
        ...
        public async Task<UserDTO> Get(Guid id)
        {
            ...
            //var mapper = new Mapper(config);
            return _mapper.Map<User, UserDTO>(await _unitOfWork.Users.Get(id));
        }
        ...
        public async Task<ICollection<UserDTO>> GetAll()
        {
            //var config = new MapperConfiguration(cfg => cfg.CreateMap<User, UserDTO>());
            //var mapper = new Mapper(config);
            if (_mapper.Map<ICollection<User>, ICollection<UserDTO>>(await _unitOfWork.Users.GetAll()).Count == 0)
                throw new UserException("List of Users is empty");
            return _mapper.Map<ICollection<User>, ICollection<UserDTO>>(await _unitOfWork.Users.GetAll());
        }
